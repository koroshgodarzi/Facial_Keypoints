...
class Net1_per_keypoint(nn.Module):

    def __init__(self):
        super(Net1_per_keypoint, self).__init__()
        ...
        self.dropout = nn.Dropout(p=0.5)
        self.fc1 = nn.Linear(64*output_size*output_size, 2)
...
class Net1_ELU(nn.Module):

    def __init__(self):
        super(Net1_ELU, self).__init__()
...
class Net3_per_keypoint(nn.Module):

    def __init__(self, conv_layer_num=3):
        super(Net3_per_keypoint, self).__init__()
        ...
        self.dropout = nn.Dropout(p=0.5)
        self.fc1 = nn.Linear(256*output_size*output_size, 2)
...
class Net3_per_keypoint_deep(nn.Module):

    def __init__(self, conv_layer_num=3):
        super(Net3_per_keypoint_deep, self).__init__()
        ...
        self.conv3 =  nn.Conv2d(8, 32, 3, padding='same')
        self.conv4 =  nn.Conv2d(32, 16, 3, padding='same')
        self.conv5 =  nn.Conv2d(16, 64, 3, padding='same')
        self.conv6 =  nn.Conv2d(64, 32, 3, padding='same')
        self.conv7 =  nn.Conv2d(32, 128, 3, padding='same')
        self.conv8 =  nn.Conv2d(128, 64, 3, padding='same')
        self.conv9 =  nn.Conv2d(64, 256, 3, padding='same')
        self.conv10 =  nn.Conv2d(256, 128, 3, padding='same')
        self.conv11 =  nn.Conv2d(128, 512, 3, padding='same')
        self.conv12 =  nn.Conv2d(512, 256, 3, padding='same')
        self.conv13 =  nn.Conv2d(256, 128, 1, padding='same')
        ...
        self.dropout = nn.Dropout(p=0.5)
        self.fc1 = nn.Linear(128*output_size*output_size, 2)
...
class Net3_ELU(nn.Module):

    def __init__(self, conv_layer_num=3):
        super(Net3_ELU, self).__init__()
...
class Net3_dropout(nn.Module):
    ...
    def __init__(self, conv_layer_num=3):
        ...
        self.conv7 =  nn.Conv2d(64, 512, 3, padding=1)
        self.conv8 =  nn.Conv2d(512, 256, 3, padding=1)
        self.dropoutCNN = nn.Dropout(p=0.2)
